...
import { KEYCLOAK_CONFIG, KeycloakClientConfigService, KeycloakClientConfig, AUTH_API_URL } from '@microfrontends/shared-services';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    { provide: APP_BASE_HREF, useValue: '/laboratorios/' },
