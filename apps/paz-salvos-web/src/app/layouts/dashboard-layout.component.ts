    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          // @ts-ignore
          requiredRoles: ['USUARIO', 'ADMIN', 'PS_SOLICITANTE', 'PS_REVISOR', 'PS_APROBADOR'],
        },
        {
          id: 'nuevaSolicitud',
          label: 'Nueva Solicitud',
          icon: 'pi pi-plus-circle',
          route: '/app/nueva-solicitud',
          // @ts-ignore
          requiredRoles: ['USUARIO', 'ADMIN', 'PS_SOLICITANTE'],
        },
        {
          id: 'revision',
          ...
          route: '/app/revision',
          // @ts-ignore
          requiredRoles: ['ADMIN', 'PS_REVISOR'],
        },
        {
          id: 'aprobacion',
          ...
          // @ts-ignore
          requiredRoles: ['ADMIN', 'PS_APROBADOR'],
        },
      ],
    },
    {
